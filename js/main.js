...
function _via_load_canvas_regions() {
  console.log('_via_load_canvas_regions');
...
function select_only_region(region_id) {
  console.log('select_only_region');
...
_via_reg_canvas.addEventListener('mousedown', function(e) {
  console.log('user clicks on the canvas')
  _via_click_x0 = e.offsetX; _via_click_y0 = e.offsetY;
...
// контрольная точка для изменения размера границ региона
...
function _via_draw_rect_region(x, y, w, h, is_selected) {
    ...
    if ( w > VIA_THEME_REGION_BOUNDARY_WIDTH && h > VIA_THEME_REGION_BOUNDARY_WIDTH ) {
        ...
        // рисуем граничную линию с обеих сторон линии заливки
        //console.log('c')
